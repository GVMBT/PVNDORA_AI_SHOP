...
const FEATURES = [
  {
    id: 1,
    title: "Мгновенная цифровая доставка",
    description: "Автоматизированная система выдачи реквизитов сразу после обработки транзакции.",
    icon: <Zap className="w-8 h-8 text-pandora-cyan" />,
    stat: "LATENCY: < 0.5s"
  },
  {
    id: 2,
    title: "Гарантия валидности",
    description: "Проверка работоспособности цифровых товаров перед выдачей клиенту.",
  ...
  },
  {
    ...
    description: "Оперативное решение технических вопросов по авторизации в сервисах.",
    ...
    <section className="relative w-full text-white pt-0 pb-24 px-6 md:pl-28 overflow-hidden z-20 bg-transparent">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-16 md:mb-24">
          ...
          >
              ...
              <h2 className="text-3xl md:text-5xl font-display font-bold text-white uppercase tracking-tight flex flex-col md:block">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-pandora-cyan to-white">ГАРАНТИИ</span>
              </h2>
              ...
              <div className="h-full bg-[#080808]/80 backdrop-blur-sm border border-white/10 p-8 relative overflow-hidden transition-all duration-500 hover:border-pandora-cyan/50 hover:bg-[#0c0c0c]/90">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/5 flex items-center justify-between bg-black/20">
                    <div className="flex items-center gap-2">
                        <Activity size={14} className="text-gray-600 group-hover:text-pandora-cyan transition-colors" />
                        <span className="font-mono text-[10px] text-pandora-cyan tracking-wider">{feature.stat}</span>
                    </div>
        ...
        <div className="mt-20 border-t border-white/10 pt-6 flex justify-between items-center opacity-40 font-mono text-[10px]">
             <span>SECURE_SOCKET_LAYER: ENCRYPTED</span>
             <span className="hidden sm:inline">NODES_ACTIVE: 3/3</span>
             <span>PANDORA_PROTOCOL_V2.0</span>
        </div>
