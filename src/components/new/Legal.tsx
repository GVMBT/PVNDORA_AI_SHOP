...
const legalContent = {
    ...
    ru: {
      ...
      content: (
        <div className="space-y-6 text-gray-400 font-mono text-xs md:text-sm leading-relaxed">
          <p>Настоящее Пользовательское соглашение (далее – «Соглашение») является публичной офертой и определяет условия использования сервиса <strong>PVNDORA</strong>, включающего Telegram-бота и Telegram Mini App (веб-приложение), размещенных в мессенджере Telegram, между Администрацией сервиса (далее – «Администрация») и Пользователем (далее – «Пользователь»).</p>
          
          <p><strong>1. ПРЕДМЕТ СОГЛАШЕНИЯ</strong></p>
          <p>1.1. Администрация предоставляет Пользователю доступ к сервису PVNDORA, включающему Telegram-бота и Telegram Mini App, на условиях, изложенных в настоящем Соглашении.</p>
          <p>1.2. Пользователь, используя сервис PVNDORA (через бота или Mini App), подтверждает свое полное и безоговорочное согласие с условиями настоящего Соглашения.</p>
          <p>1.3. Настоящее Соглашение является юридически обязательным документом.</p>

          <p><strong>2. ОПИСАНИЕ СЕРВИСА И ЕГО ФУНКЦИОНАЛЬНОСТИ</strong></p>
          <p>2.1. Сервис <strong>PVNDORA</strong> предназначен для предоставления доступа к премиум подпискам на платформы искусственного интеллекта и цифровые сервисы посредством передачи лицензионных ключей, инвайт-ссылок или учетных данных для доступа к готовым аккаунтам.</p>
          <p>2.1.1. Сервис состоит из двух компонентов: Telegram-бота (для команд и взаимодействия) и Telegram Mini App (веб-приложение для просмотра каталога, оформления заказов и управления аккаунтом).</p>
          <p>2.2. Сервис является реселлером (перепродавцом) подписок на сторонние SaaS-платформы (включая, но не ограничиваясь: OpenAI ChatGPT, Anthropic Claude, Midjourney, GitHub Copilot, Cursor IDE, Eleven Labs и другие). Все услуги предоставляются на условиях оригинальных провайдеров.</p>
          <p>2.3. Перечень функций и возможностей Бота может быть изменен Администрацией без предварительного уведомления Пользователя.</p>

          <p><strong>3. ПРАВИЛА ИСПОЛЬЗОВАНИЯ СЕРВИСА</strong></p>
          <p>3.1. Пользователь обязуется использовать сервис PVNDORA (бот и Mini App) исключительно в соответствии с его целевым назначением и в рамках действующего законодательства.</p>
          <p>3.2. Пользователь не имеет права:</p>
          <ul className="list-disc list-inside ml-4 space-y-1">
            <li>Пытаться получить несанкционированный доступ к информации, содержащейся в сервисе.</li>
            <li>Использовать сервис для распространения вредоносного программного обеспечения, спама или другой незаконной информации.</li>
            ...
            <li>Передавать полученные данные доступа третьим лицам без разрешения Администрации.</li>
          </ul>
          <p>3.3. Администрация оставляет за собой право ограничить или прекратить доступ Пользователя к сервису в случае нарушения им условий настоящего Соглашения.</p>
          <p>3.4. Администрация обязуется обеспечить предоставление доступа в течение 24 часов с момента подтверждения транзакции, если иное не указано в описании товара.</p>

          <p><strong>4. ОТВЕТСТВЕННОСТЬ СТОРОН</strong></p>
          <p>4.1. Администрация не несет ответственности за убытки, причиненные Пользователю в результате использования сервиса PVNDORA, в том числе за возможные ошибки в работе бота или Mini App, перерывы в работе, потерю данных и т.д.</p>
          <p>4.2. Администрация не несет ответственности за изменения в алгоритмах работы, функционале или условиях использования сервисов, производимых их оригинальными разработчиками.</p>
          <p>4.3. Администрация не несет ответственности за ограничение доступа к сервисам со стороны оригинальных провайдеров, включая блокировки аккаунтов по их усмотрению.</p>
          <p>4.4. Администрация не несет ответственности за содержание информации, размещенной Пользователем в сервисе.</p>
          <p>4.5. Пользователь несет полную ответственность за свои действия при использовании сервиса, а также за последствия таких действий.</p>
          <p>4.6. Пользователь несет полную ответственность за использование полученных данных доступа в соответствии с условиями оригинальных провайдеров.</p>

          <p><strong>5. ОБРАБОТКА ПЕРСОНАЛЬНЫХ ДАННЫХ</strong></p>
          <p>5.1. Администрация обязуется соблюдать конфиденциальность персональных данных Пользователя, полученных в процессе использования сервиса PVNDORA (бота и Mini App).</p>
          <p>5.2. Подробная информация об обработке персональных данных содержится в Политике конфиденциальности, являющейся неотъемлемой частью настоящего Соглашения.</p>

          <p><strong>6. СРОК ДЕЙСТВИЯ И ПОРЯДОК ИЗМЕНЕНИЯ СОГЛАШЕНИЯ</strong></p>
          <p>6.1. Настоящее Соглашение вступает в силу с момента его принятия Пользователем и действует бессрочно.</p>
          <p>6.2. Администрация оставляет за собой право вносить изменения в настоящее Соглашение. Информация об изменениях будет размещена в боте и Mini App. Пользователь считается принявшим изменения, если он продолжает использовать сервис после внесения изменений.</p>

          <p><strong>7. РАЗРЕШЕНИЕ СПОРОВ</strong></p>
          <p>7.1. Все споры, возникающие между Администрацией и Пользователем в связи с настоящим Соглашением, подлежат разрешению в порядке, предусмотренном действующим законодательством.</p>
          <p>7.2. Все споры разрешаются путем переговоров, при недостижении согласия — в соответствии с действующим законодательством.</p>

          <p><strong>8. ПРОЧИЕ УСЛОВИЯ</strong></p>
          <p>8.1. Во всем остальном, что не предусмотрено настоящим Соглашением, стороны руководствуются действующим законодательством.</p>
          <p>8.2. Если какое-либо положение настоящего Соглашения будет признано недействительным, это не повлияет на действительность остальных положений.</p>

          <p><strong>КОНТАКТНАЯ ИНФОРМАЦИЯ АДМИНИСТРАЦИИ:</strong></p>
          <p>Email: <a href="mailto:support@pvndora.app" className="text-pandora-cyan hover:underline">support@pvndora.app</a></p>
          <p>Telegram: <a href="https://t.me/pvndora_support" target="_blank" rel="noopener noreferrer" className="text-pandora-cyan hover:underline">@pvndora_support</a></p>
        </div>
      )
    },
    en: {
  ...
  privacy: {
    ru: {
      ...
      content: (
        <div className="space-y-6 text-gray-400 font-mono text-xs md:text-sm leading-relaxed">
          <p>Настоящее соглашение о конфиденциальности использования персональных данных (далее — Соглашение о конфиденциальности) регулирует порядок сбора, использования и разглашения Администрацией PVNDORA информации о Пользователе, которая может быть признана конфиденциальной или является таковой в соответствии с законодательством РФ.</p>
          <p>Факт использования Пользователем сервиса PVNDORA (Telegram-бота и Telegram Mini App) является полным и безоговорочным акцептом настоящего Соглашения. Незнание указанных соглашений не освобождает Пользователя от ответственности за несоблюдение их условий.</p>
          <p>Если Пользователь не согласен с условиями настоящего Соглашения или не имеет права на заключение Соглашения, Пользователю следует незамедлительно прекратить любое использование сервиса PVNDORA.</p>

          <p><strong>1. ИСТОЧНИКИ ИНФОРМАЦИИ</strong></p>
          <p>1.1. Информация, о которой идёт речь в настоящем соглашении, может быть персонифицированной (прямо относящейся к конкретному лицу или ассоциируемой с ним) и не персонифицированной (данные о Пользователе Telegram-бота, полученные без привязки к конкретному лицу).</p>
          <p>1.2. Администрации доступна информация, получаемая следующими способами:</p>
          <ul className="list-disc list-inside ml-4 space-y-1">
            <li>Информация, полученная при переписке Администрации с Пользователями сервиса PVNDORA посредством электронной почты или мессенджера Telegram;</li>
            <li>Информация, предоставляемая Пользователями при использовании Telegram-бота или Telegram Mini App, в рамках мероприятий, проводимых Администрацией, опросах, заявках, формах обратной связи;</li>
            <li>Техническая информация — данные об интернет-провайдере Пользователя, IP-адресе Пользователя, характеристиках используемого устройства и программного обеспечения;</li>
            <li>Статистические данные о предпочтениях отдельно взятого Пользователя (история заказов, просмотренные товары);</li>
          ...
          <p>1.3. Конфиденциальной, согласно настоящему Соглашению, может быть признана лишь информация, хранящаяся в базе данных сервиса PVNDORA в зашифрованном виде и доступная для просмотра исключительно Администрации.</p>
          <p>1.4. Информация о лице, добровольно размещённая им в общих разделах сервиса (бота или Mini App) при заполнении регистрационных форм и доступная любому другому пользователю, или информация, которая может быть свободно получена из других общедоступных источников, не является конфиденциальной.</p>
          <p>1.5. Мы НЕ собираем данные банковских карт, пароли или другую конфиденциальную финансовую информацию. Все платежные данные обрабатываются сторонними платежными системами (CrystalPay и другие) и не сохраняются на наших серверах.</p>

          <p><strong>2. БЕЗОПАСНОСТЬ</strong></p>
          <p>2.1. Администрация сервиса PVNDORA использует современные технологии обеспечения конфиденциальности персональных данных, данных, полученных из регистрационных форм, оставляемых Пользователями в боте или Mini App, с целью обеспечения максимальной защиты информации.</p>
          <p>2.2. Все данные передаются по защищенному протоколу SSL/TLS. Платежные данные обрабатываются на стороне платежных шлюзов (CrystalPay, внутренний баланс) и не сохраняются на наших серверах.</p>
          <p>2.3. Доступ к личной информации Пользователя осуществляется через систему авторизации Telegram (initData для Mini App). Пользователь обязуется самостоятельно обеспечить сохранность авторизационных данных и ни под каким предлогом не разглашать их третьим лицам.</p>
          <p>2.4. Сбор, хранение, использование, обработка, разглашение информации, полученной Администрацией в результате использования Пользователем сервиса PVNDORA (бота или Mini App), в том числе и персональные данные пользователей, осуществляется администрацией в соответствии с законодательством РФ.</p>
          <p>2.5. Доступ к персональным данным имеют только уполномоченные сотрудники, необходимые для выполнения обязательств перед Пользователем.</p>
          <p>2.6. Мы применяем меры для защиты данных от несанкционированного доступа, изменения, раскрытия или уничтожения.</p>
          <p>2.7. Пользователь осознает и предоставляет согласие на сбор и обработку своих персональных данных Администрацией в рамках и с целью, предусмотренными условиями Пользовательского соглашения; обязуется уведомлять Администрацию об изменениях его персональных данных.</p>
          ...
          <p>3.2. Мы не передаем личные данные третьим лицам, за исключением случаев, предусмотренных законодательством.</p>
          ...
          <p>4.2. Для реализации прав пользователя необходимо обратиться в службу поддержки: <a href="mailto:support@pvndora.app" className="text-pandora-cyan hover:underline">support@pvndora.app</a> или <a href="https://t.me/pvndora_support" target="_blank" rel="noopener noreferrer" className="text-pandora-cyan hover:underline">@pvndora_support</a></p>
          ...
          <p>5.1. Деятельность Администрации сервиса PVNDORA осуществляется в соответствии с законодательством РФ. Любые претензии, споры, официальные обращения будут рассматриваться исключительно в порядке, предусмотренном законодательством РФ.</p>
          <p>5.2. Администрация сервиса PVNDORA не несёт ответственности за любые прямые или косвенные убытки, понесённые Пользователями или третьими сторонами, а также за упущенную выгоду при использовании, невозможности использования или результатов использования сервиса.</p>
          <p>5.3. Условия настоящего Соглашения могут быть изменены Администрацией сервиса PVNDORA в одностороннем порядке.</p>
        </div>
      )
    },
    en: {
