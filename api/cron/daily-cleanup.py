...
async def handler(request: Request):
    ...
    try:
        ...
        stuck_reservations = db.client.table("stock_items").update({
            "status": "available",
            "reserved_at": None
        ...
        old_wishlist = db.client.table("wishlist").delete().eq(
            "reminded", True
