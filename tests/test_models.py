...
from core.models import ActionType, AIResponse, CartItemResponse, IntentType, OrderStatus, OrderType
...
class TestAIResponse:
    ...
    def test_default_action(self):
        ...
        response = AIResponse(thought="General query", reply_text="Hello!")
