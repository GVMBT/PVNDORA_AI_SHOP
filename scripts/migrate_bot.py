...
async def main():
    ...
    parser.add_argument("--webhook-url", default=None, help="Webhook URL (defaults to WEBAPP_URL/webhook/telegram)")
    parser.add_argument("--channel", default="@pvndora_news", help="Channel to announce migration")
    parser.add_argument("--discount", action="store_true", help="Migrate discount bot instead of main")
