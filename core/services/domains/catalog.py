...
class ProductAvailability:
    ...
    fulfillment_time_hours: Optional[int] = None
...
class PurchaseIntent:
    ...
    price: float = 0.0
    order_type: Optional[str] = None  # 'instant' or 'prepaid'
    fulfillment_time_hours: Optional[int] = None
    ...
    async def search(
        ...
        if rag_search:
            try:
                ...
                if category != "all":
                    category_map = {
                        "chatgpt": "shared", "claude": "shared", 
                        "midjourney": "shared", "image": "shared",
                        "code": "key", "writing": "shared"
                    }
