...
def add(a: str | float | Decimal, b: str | float | Decimal) -> Decimal:
    """Safe addition of monetary values."""
    return to_decimal(a) + to_decimal(b)


def subtract(a: str | float | Decimal, b: str | float | Decimal) -> Decimal:
    """Safe subtraction of monetary values."""
    return to_decimal(a) - to_decimal(b)


def multiply(value: str | float | Decimal, factor: str | float | Decimal) -> Decimal:
    """Safe multiplication of monetary value by a factor."""
    return to_decimal(value) * to_decimal(factor)


def divide(value: str | float | Decimal, divisor: str | float | Decimal) -> Decimal:
...
def percent(value: str | float | Decimal, percent_value: str | float | Decimal) -> Decimal:
