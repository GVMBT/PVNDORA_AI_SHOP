...
class PaymentService:
    ...
    async def _lookup_order_id(self, payment_id: Optional[str]) -> Tuple[Optional[str], Optional[str]]:
    ...
    async def verify_crystalpay_webhook(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("CrystalPay webhook verified: order=%s, amount=%s %s", order_id, amount, currency)
            return {
                "success": True,
                "order_id": order_id,
                "amount": amount,
