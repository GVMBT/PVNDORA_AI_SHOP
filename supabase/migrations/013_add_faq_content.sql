...
'Приглашайте друзей по реферальной ссылке и получайте 10% с их покупок (1 уровень). При достижении оборота $250+ вы также получаете 7% с покупок 2-й линии, а при $1000+ — ещё 3% с 3-й линии. Все бонусы начисляются на ваш баланс и могут быть выведены.', 
'general', 'ru', 7, true),
