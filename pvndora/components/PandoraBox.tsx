    ...
    <div className="w-full h-full absolute inset-0 pointer-events-none overflow-visible flex items-center justify-center">
      ...
      >
        ...
        <g transform="translate(400, 420) scale(1, 0.35)" opacity="0.6" mask="url(#floor-mask)">
            <circle cx="0" cy="0" r="150" stroke="#00FFFF" strokeWidth="1" strokeOpacity="0.1" strokeDasharray="5 5"/>
        ...
        <g transform="translate(400, 300)">
            <g className="spin-slow" opacity="0.15">
                ...
                <path d="M-170 0 A170 170 0 0 0 170 0" stroke="#00FFFF" strokeWidth="1" strokeDasharray="10 20" fill="none" />
            </g>
        </g>
        ...
        <g className="levitation">
            ...
            <g transform="translate(300, 200)">
                ...
                <g className="core-pulse" transform-origin="100 100">
                    <circle cx="100" cy="110" r="45" fill="url(#core-light)" filter="url(#glow-intense)"/>
                    {/* Beams shooting up */}
                    <path d="M100 20 L100 200" stroke="#00FFFF" strokeWidth="4" opacity="0.8" filter="url(#glow-intense)"/>
                    <path d="M80 50 L120 170" stroke="#00FFFF" strokeWidth="1" opacity="0.4" filter="url(#glow-intense)"/>
                </g>
                ...
                <g className="panel-top"> 
                    ...
                    <path d="M100 20 L180 60 L100 100 L20 60 Z" fill="none" stroke="#00FFFF" strokeWidth="0.8" strokeOpacity="0.4" />
                ...
                <g className="panel-right">
                    ...
                    <path d="M100 100 L180 60 V 150 L100 190 Z" fill="none" stroke="#00FFFF" strokeWidth="0.8" strokeOpacity="0.4" />
                    <path d="M165 80 V 130" stroke="#00FFFF" strokeWidth="1.5" opacity="0.6" filter="url(#glow-intense)" />
                ...
                <g className="panel-left">
                    ...
                    <path d="M100 100 L20 60 V 150 L100 190 Z" fill="none" stroke="#00FFFF" strokeWidth="0.8" strokeOpacity="0.4" />
                    <path d="M35 80 V 130" stroke="#00FFFF" strokeWidth="1.5" opacity="0.6" filter="url(#glow-intense)" />
                ...
                <g className="holo-flicker" transform="translate(0, 0)">
                     <path d="M100 15 L185 58 L185 155 L100 195 L15 155 L15 58 Z" fill="none" stroke="#ff0000" strokeWidth="0.5" strokeOpacity="0.1" strokeDasharray="4 2" />
                </g>
            ...
            <g transform="translate(300, 200)">
                ...
                <path d="M100 80 L100 60" stroke="url(#neon-stream)" strokeWidth="0.5" className="particle p4" />
